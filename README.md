# MaimaiPy
Cookie-based data fetcher using Python.

> [!NOTE]
> Initially forked from [swyrin/paranormal-maimai](https://github.com/swyrin/paranormal-maimai). Detached as most of the codebase and features have been completely rewritten.
